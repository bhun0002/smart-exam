...
export default function FiltersBar({
  ...
  return (
    <Paper elevation={2} sx={{ p: 2, mb: 2, borderRadius: "14px", bgcolor: "#fff", border: "1px solid #eef2f6" }}>
      <Box sx={{ display: "grid", gridTemplateColumns: "1.5fr auto auto auto", gap: 1.5, alignItems: "center" }}>
        <TextField
        ...
        <Stack direction="row" gap={1} justifyContent="flex-end">
          <Chip
            label={onlyMandatory ? "Mandatory" : "All"}
            color={onlyMandatory ? "warning" : "default"}
