...
const FiltersBar = ({
  ...
  coursesMap = {},                 // NEW: { courseId: "Course Name" }
  search, setSearch,               // string
  intakeId, setIntakeId,           // 'all' | intakeId
  courseId, setCourseId,           // NEW: 'all' | courseId
  ...
  const courseOptions = Object.entries(coursesMap);   // NEW
    ...
    <Box
      sx={{
        ...
        gridTemplateColumns: {
          xs: "1fr",
          sm: "1fr 1fr",
          // expanded by one column to fit Course
          md: "1.2fr 1fr 1fr 1fr 1fr 0.9fr auto",
        },
        gap: 2,
        p: 2,
        mb: 2,
