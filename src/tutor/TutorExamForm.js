    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (onSaveSuccess) {
                ...
                setTimeout(() => {
                    navigate('/tutor-exam-list'); // Navigate to list after saving a new exam
                }, 2000);
            }
        ...
        >
            <Paper elevation={12} sx={{ padding: { xs: 3, md: 5 }, borderRadius: '24px', backgroundColor: '#ffffff' }}>
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 4 }}>
                    ...
                    <Typography variant="h4" gutterBottom textAlign="center" fontWeight="bold" color="#37474f" sx={{ flexGrow: 1 }}>
